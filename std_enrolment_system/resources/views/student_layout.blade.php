  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('student_dashboard')}}"><img src="images/std.png" alt="Logo"></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              <img src="{{URL::to(Session::get('student_image'))}}" alt="">
            </div>
            
            <div class="details">
              <p class="user-name bold">{{Session::get('student_name')}}</p>
              <p class="designation text-muted">Dept. of {{Session::get('student_department')}}</p>
            </div>
          </div>
          <ul class="nav">
            <!--main pages start-->
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/all_students')}}">
                ...
                <span class="menu-title">Academic Information</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/add_students')}}">
                <i class="mdi mdi-plus-outline menu-icon"></i>
                <span class="menu-title">My Payment</span>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/add_teachers')}}">Routine</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/all_teachers')}}">Notice</a>
                  </li>
                </ul>
              </div>
            </li>
